      ...
      <div className="mx-auto max-w-7xl space-y-28 px-6">
        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          <div>
            ...
            <h2 className="mb-6 text-5xl font-bold leading-tight text-[#061b0e]">
            ...
            <button
              ...
              className="rounded-2xl bg-[#061b0e] px-8 py-4 text-sm uppercase tracking-[0.2em] text-white transition hover:opacity-90"
            >
              Buy Now
            </button>
          </div>
