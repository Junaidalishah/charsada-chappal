  ...
  return (
    <>
      ...
      <main className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        {/* HEADER */}
        <div className="mb-12">
          <button onClick={() => navigate("/shop")} className="text-xs uppercase tracking-widest opacity-60 hover:opacity-100 cursor-pointer">
            ← Continue Shopping
          </button>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7">
            <h1 className="text-4xl font-serif mb-12 tracking-tight">
              BAG
            </h1>
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-28 bg-[#f7f5f1] p-10 rounded-2xl shadow-sm">
              ...
              {/* BUTTON */}
              <button className="w-full bg-black text-white py-4 rounded-xl text-xs uppercase tracking-widest hover:bg-gray-800 transition cursor-pointer">
                Proceed to Checkout
              </button>
