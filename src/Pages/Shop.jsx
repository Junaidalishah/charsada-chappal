    ...
    <div className="font-body bg-background text-on-surface selection:bg-secondary-container">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#fbf9f5]/80 dark:bg-[#061b0e]/80 backdrop-blur-xl flex justify-between items-center px-6 py-4 max-w-none">
        <div className="flex items-center gap-8">
          ...
          <div className="bg-blue-500 hover:bg-green-500 p-10 animate-fade-up">
            Hover me
          </div>
                ...
                <div key={product.id} className="group cursor-pointer">
                  <div className="relative aspect-[3/4] overflow-hidden bg-surface-container-low mb-6">
                    ...
                    <img
                      ...
                      alt={product.title}
                    />
                    <div className="absolute inset-0 flex items-end justify-center pb-8 bg-black/0 opacity-0 group-hover:opacity-100 group-hover:bg-black/20 transition-all duration-300 backdrop-blur-[2px]">
                      <button className="bg-[#1B3022] text-white px-8 py-3 text-xs uppercase tracking-widest font-medium rounded-xl transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                        Add to Cart
                      </button>
                    </div>
                  </div>
